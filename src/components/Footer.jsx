...
const Footer = () => {
  return (
    <footer className="lg:fixed bottom-0 right-1/4 z-20 lg:bottom-0 lg:right-5 lg:top-1/2 md:bottom-0 md:right-10 md:top-1/2 sm:bottom-0 sm:right-5 sm:top-1/2">
      <div className="p-4 rounded-lg">
        <div className="flex flex-col gap-4 items-center lg:gap-10 sm:gap-4 md:gap-8">
